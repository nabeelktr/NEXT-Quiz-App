  ...
  return (
    <>
      {!result.isScore && !loading && (
        <Typography placeholder={""} className="animate-slidein700 opacity-0 pt-14 text-2xl font-medium">
      ...
      {loading ? (
        ...
        <Card className="animate-slidein300 opacity-0 mt-6 w-96 bg-white" placeholder={""}>
